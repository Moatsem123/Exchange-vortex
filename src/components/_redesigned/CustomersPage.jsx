...
// تحويل العميل من شكل الـ API لشكل اليو آي
function mapCustomer(c) {
  return {
    ...
    _raw: c, // البيانات الأصلية للتعديل والإرسال
  };
}
...
function CustomersPage() {
  ...
  // جلب العملاء من الـ API أول ما تفتح الصفحة
  useEffect(() => {
  ...
  async function handleAddCustomer(newCustomer) {
    try {
      // newCustomer جاي من الفورم بشكل { name, phone, category, country, note }
