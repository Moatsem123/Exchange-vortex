// =====================================================
// LoginPage.jsx — ربط مباشر بـ axios، بدون أي service
...
import api from "../services/api"; // 👈 نفس الـ axios instance المستخدم بكل المشروع

function LoginPage({ onLogin }) {
  // 1) state للحقول والتحميل والخطأ
  const [email, setEmail] = useState("");
  const [password, setPassword] = useState("");
  const [showPassword, setShowPassword] = useState(false); // 👈 جديد: إظهار/إخفاء كلمة المرور
  ...
  async function handleLogin() {
    ...
    setLoading(true);
    try {
      // 👇 نداء axios مباشر — لا يوجد service
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  >
                    ...
                    {/* 👇 type ديناميكي حسب showPassword */}
                    <input
